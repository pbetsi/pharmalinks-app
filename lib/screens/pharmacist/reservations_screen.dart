...
class _PharmacistReservationsScreenState extends State<PharmacistReservationsScreen> {
  ...
  Future<void> _loadPharmacyAndReservations() async {
    ...
    try {
      ...
      print('🔍 Chargement des réservations pour pharmacy_id: ${user.id}');
      ...
      // ✅ CORRIGÉ : Utiliser patient_name, patient_phone au lieu de users()
      ...
      print('✅ Réservations chargées: ${resRes.length}');
  ...
  // ✅ FONCTION DE NOTIFICATION WHATSAPP/SAM CORRIGÉE
  Future<void> _notifyPatient(Map<String, dynamic> res, String type) async {
    // ✅ Utiliser patient_name et patient_phone au lieu de users
    final patientPhone = res['patient_phone'];
    final patientName = res['patient_name'] ?? 'Patient';
    final medName = res['medicines']?['name'] ?? 'médicament';
    ...
    String message = "Bonjour $patientName, votre commande de $medName est confirmée chez Pharmalink. Passez la récupérer !";
    String url = "";
                  ...
                  : _reservations.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            // ✅ Utiliser patient_name et patient_phone
                            final patientPhone = res['patient_phone'];
                            final patientName = res['patient_name'] ?? 'Patient';
                            final medName = res['medicines']?['name'] ?? 'Médicament';
